<?php /* Smarty version 2.6.31, created on 2019-08-27 09:09:19
         compiled from cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 327, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 344, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Prospects/SearchForm_popup_query_form.tpl', 425, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='first_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assistant_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSISTANT','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['assistant_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['assistant_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['assistant_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['assistant_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['assistant_advanced']['name']; ?>
' size='30' 
    maxlength='75' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='do_not_call_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DO_NOT_CALL','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_street_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_ADDRESS','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_state_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_postalcode_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSTAL_CODE','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_country_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_COUNTRY','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
