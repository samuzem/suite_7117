...
addToValidate('form_QuickCreate_Contacts', 'opportunities_contacts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_CONTACTS_1_FROM_OPPORTUNITIES_TITLE' module='Contacts' for_js=true}{literal}' );
