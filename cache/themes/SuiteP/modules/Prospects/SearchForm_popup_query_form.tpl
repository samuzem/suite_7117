...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='first_name_advanced'>{sugar_translate label='LBL_FIRST_NAME' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.first_name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_advanced'>{sugar_translate label='LBL_LAST_NAME' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.last_name_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_advanced'>{sugar_translate label='LBL_ANY_PHONE' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.phone_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'>{sugar_translate label='LBL_ANY_EMAIL' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.email_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assistant_advanced'>{sugar_translate label='LBL_ASSISTANT' module='Prospects'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.assistant_advanced.value) <= 0}
{assign var="value" value=$fields.assistant_advanced.default_value }
{else}
{assign var="value" value=$fields.assistant_advanced.value }
{/if}  
<input type='text' name='{$fields.assistant_advanced.name}' 
    id='{$fields.assistant_advanced.name}' size='30' 
    maxlength='75' 
    value='{$value}' title=''      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='do_not_call_advanced'>{sugar_translate label='LBL_DO_NOT_CALL' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<select id="{$fields.do_not_call_advanced.name}" name="{$fields.do_not_call_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_street_advanced'>{sugar_translate label='LBL_ANY_ADDRESS' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_street_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_state_advanced'>{sugar_translate label='LBL_STATE' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_state_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_postalcode_advanced'>{sugar_translate label='LBL_POSTAL_CODE' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_postalcode_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_country_advanced'>{sugar_translate label='LBL_COUNTRY' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.primary_address_country_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Prospects'}</label>
                            </div>
            <div class="form-item">
