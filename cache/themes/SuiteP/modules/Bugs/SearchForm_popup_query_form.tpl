...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='bug_number_advanced'>{sugar_translate label='LBL_NUMBER' module='Bugs'}</label>
                            </div>
            <div class="form-item">
...
{/if}  
<input type='text' name='{$fields.bug_number_advanced.name}' 
    id='{$fields.bug_number_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_SUBJECT' module='Bugs'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='priority_advanced'>{sugar_translate label='LBL_PRIORITY' module='Bugs'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='priority_advanced' name='priority_advanced[]' options=$fields.priority_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.priority_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='Bugs'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_advanced'>{sugar_translate label='LBL_TYPE' module='Bugs'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='type_advanced' name='type_advanced[]' options=$fields.type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='product_category_advanced'>{sugar_translate label='LBL_PRODUCT_CATEGORY' module='Bugs'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='product_category_advanced' name='product_category_advanced[]' options=$fields.product_category_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.product_category_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Bugs'}</label>
                            </div>
            <div class="form-item">
