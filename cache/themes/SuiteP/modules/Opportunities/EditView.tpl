...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CAMPOPROGRESSIVO' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.campoprogressivo_c.value) <= 0}
{assign var="value" value=$fields.campoprogressivo_c.default_value }
{else}
{assign var="value" value=$fields.campoprogressivo_c.value }
{/if}  
<input type='text' name='{$fields.campoprogressivo_c.name}' 
id='{$fields.campoprogressivo_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'ciao', 'bool', false,'{/literal}{sugar_translate label='Ciao Opportunità' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'accounts_opportunities_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS_OPPORTUNITIES_2_FROM_ACCOUNTS_TITLE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'contacts_opportunities_2_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACTS_OPPORTUNITIES_2_FROM_CONTACTS_TITLE' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'campoprogressivo_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CAMPOPROGRESSIVO' module='Opportunities' for_js=true}{literal}' );
addToValidateRange('EditView', 'nopportunita_c', 'int', false, '{/literal}{sugar_translate label='LBL_NOPPORTUNITA' module='Opportunities' for_js=true}{literal}', 0, false);
