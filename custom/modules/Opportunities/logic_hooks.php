...
$hook_array['before_save'][] = Array(
    2,
    'Nella descrione scrive pippo',
    'custom/modules/Opportunities/custom_logic.php',
    'Opportunitieslogichook',
    'parent' 
    );
...
$hook_array['before_save'][] = Array(
    3,
    'Cambia open in close se verificata la condizione',
    'custom/modules/Opportunities/logic_hooks1.php',
    'Opportunitieslogichook1',
    'updateCase'
    );
...
$hook_array['before_save'][] = Array(
    4,
    'dewfqjwfe',
    'custom/modules/Opportunities/logic_hooks2.php',
    'Opportunitieslogichook2',
    'campoopp'
    );
